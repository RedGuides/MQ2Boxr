...
public:
	...
	virtual void SetCampRadius(int campRadius) = 0;
...
public:
	...
	void SetCampRadius(int campRadius) override;
...
public:
	...
	void SetCampRadius(int campRadius) override { LOG_NOOP_WARNING; }
...
public:
	...
	void Camp();
	void Manual();
	void CampRadius(int campRadius);
	void RaidAssistNum(int raidAssistNum);

private:
	MasterBoxControl() = default;
	KissAssistControl kissAssistControl = KissAssistControl();
	RGMercsControl rgmercsControl = RGMercsControl();
	CwtnControl cwtnControl = CwtnControl();
	NoopControl noopControl = NoopControl();
	BoxControl* getBox();
};
